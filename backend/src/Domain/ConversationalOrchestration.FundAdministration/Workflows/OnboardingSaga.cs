...
public sealed class OnboardingSaga :
    ...
    IAmStartedByMessages<StartFundOnboardingCommand>,
    IHandleMessages<ContinueFundOnboardingReviewCommand>,
    ...
    IHandleTimeouts<ExtractionReadyTimeout>
{
    ...
    protected override void ConfigureHowToFindSaga(SagaPropertyMapper<OnboardingSagaData> mapper)
    {
        mapper.MapSaga(saga => saga.OperationId)
            .ToMessage<StartFundOnboardingCommand>(message => message.OperationId)
            .ToMessage<ContinueFundOnboardingReviewCommand>(message => message.OperationId);
    }

    public async Task Handle(StartFundOnboardingCommand message, IMessageHandlerContext context)
    {
    ...
    public async Task Handle(ContinueFundOnboardingReviewCommand message, IMessageHandlerContext context)
    {
